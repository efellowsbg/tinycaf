module "role_assignments" {
  ...
  resources = {
    ...
    linux_virtual_machines     = module.virtual_machines.module.linux_virtual_machines
    windows_virtual_machines = module.virtual_machines.module.windows_virtual_machines
  }
}
